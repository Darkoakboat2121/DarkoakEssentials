...
function customSlashCommands(evd) {
    ...
    evd.customCommandRegistry.registerEnum('darkoak:ptypes', ['join', 'list'])
    evd.customCommandRegistry.registerCommand({
        name: 'darkoak:p',
